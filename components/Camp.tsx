...
<div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
  <div className="bg-green-50 p-8 flex-col lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
